...
Partial Class RegisterForm
    ...
    Private Sub InitializeComponent()
        ...
        ' userName
        ' 
        userName.BackColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        userName.Font = New Font("Tw Cen MT", 12F)
        userName.ForeColor = SystemColors.Control
        userName.Location = New Point(29, 57)
        userName.Name = "userName"
        userName.PlaceholderText = "Username"
        userName.Size = New Size(286, 29)
        userName.TabIndex = 0
        ' 
        ' Label1
        ' 
        ...
        ' confirmPassword
        ' 
        confirmPassword.BackColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        confirmPassword.Font = New Font("Tw Cen MT", 12F)
        confirmPassword.ForeColor = SystemColors.Control
        confirmPassword.Location = New Point(27, 178)
        confirmPassword.Name = "confirmPassword"
        confirmPassword.PlaceholderText = "Confirm Password"
        confirmPassword.Size = New Size(286, 29)
        confirmPassword.TabIndex = 3
        confirmPassword.UseSystemPasswordChar = True
        ' 
        ' password
        ' 
        password.BackColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        password.Font = New Font("Tw Cen MT", 12F)
        password.ForeColor = SystemColors.Control
        password.Location = New Point(28, 113)
        password.Name = "password"
        password.PlaceholderText = "Password"
        password.Size = New Size(286, 29)
        password.TabIndex = 4
        ...
        nextButton.Location = New Point(115, 231)
        ...
        ' surname
        ' 
        surname.BackColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        surname.Font = New Font("Tw Cen MT", 12F)
        surname.ForeColor = SystemColors.Control
        surname.Location = New Point(29, 33)
        surname.Name = "surname"
        surname.PlaceholderText = "Surname"
        surname.Size = New Size(142, 29)
        surname.TabIndex = 7
        ' 
        ' givenName
        ' 
        givenName.BackColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        givenName.Font = New Font("Tw Cen MT", 12F)
        givenName.ForeColor = SystemColors.Control
        givenName.Location = New Point(177, 34)
        givenName.Name = "givenName"
        givenName.PlaceholderText = "Given Name"
        givenName.Size = New Size(138, 29)
        givenName.TabIndex = 8
        ' 
        ' middleName
        ' 
        middleName.BackColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        middleName.Font = New Font("Tw Cen MT", 12F)
        middleName.ForeColor = SystemColors.Control
        middleName.Location = New Point(29, 93)
        middleName.Name = "middleName"
        middleName.PlaceholderText = "Middle Name"
        middleName.Size = New Size(142, 29)
        middleName.TabIndex = 9
        ' 
        ' extensionName
        ' 
        extensionName.BackColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        extensionName.Font = New Font("Tw Cen MT", 12F)
        ...
        extensionName.Size = New Size(138, 29)
        ...
        ' unitName
        ' 
        unitName.BackColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        unitName.Font = New Font("Tw Cen MT", 12F)
        ...
        ' streetName
        ' 
        streetName.BackColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        streetName.Font = New Font("Tw Cen MT", 12F)
        ...
        streetName.Size = New Size(109, 29)
        ...
        ' areaName
        ' 
        areaName.BackColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        areaName.Font = New Font("Tw Cen MT", 12F)
        ...
        ' barangayName
        ' 
        barangayName.BackColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        barangayName.Font = New Font("Tw Cen MT", 12F)
        ...
        barangayName.Size = New Size(107, 29)
        ...
        ' cityName
        ' 
        cityName.BackColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        cityName.Font = New Font("Tw Cen MT", 12F)
        cityName.ForeColor = SystemColors.Control
        cityName.Location = New Point(27, 264)
        cityName.Name = "cityName"
        cityName.PlaceholderText = "City"
        cityName.Size = New Size(286, 29)
        cityName.TabIndex = 23
        ' 
        ' usernameLabel
        ' 
        usernameLabel.AutoSize = True
        usernameLabel.Font = New Font("Tw Cen MT", 12F)
        ...
        passwordLabel.Font = New Font("Tw Cen MT", 12F)
        passwordLabel.Location = New Point(29, 86)
        ...
        confirmPasswordLabel.Font = New Font("Tw Cen MT", 12F)
        confirmPasswordLabel.Location = New Point(27, 151)
        confirmPasswordLabel.Name = "confirmPasswordLabel"
        confirmPasswordLabel.Size = New Size(154, 23)
